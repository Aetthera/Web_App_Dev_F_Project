...
<body class="bg-light">
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            <?php echo isset($_GET['uname']) ? htmlspecialchars($_GET['uname']) : ''; ?>" required>
                    </div>
                    <div class="form-group mt-3">
            ...
            <?php echo isset($_GET['fname']) ? htmlspecialchars($_GET['fname']) : ''; ?>" required>
                    </div>
                    <div class="form-group mt-3">
                        <input type="text" name="lname" class="form-control" placeholder="Last Name" value="
            <?php echo isset($_GET['lname']) ? htmlspecialchars($_GET['lname']) : ''; ?>" required>
                    </div>
                    <div class="form-group mt-4 mb-2">
                        <div class="custom-control custom-checkbox">
